(function(window, document) {
    ...
    LazyItem.prototype = {
        ...
        getImageGroupNode: function() {
            ...
            if ((this.node.className && this.node.className.indexOf('portfolio') != -1) || (id && document.querySelector('div.portfolio #' + id) !== null && !(this.node.closest('div.portfolio').classList.contains('extended-products-grid') && this.node.closest('div.portfolio').classList.contains('portfolio-style-justified')))) {
            ...
            if ((this.node.className && this.node.className.indexOf('extended-carousel-grid') != -1) || (id && document.querySelector('div.extended-carousel-grid #' + id) !== null && (this.node.closest('div.extended-carousel-grid').classList.contains('carousel-scroll-init')))) {
